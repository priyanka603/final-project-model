...
<section class="form-container">
   ...
   <form class="register" action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="col">
            ...
            <select name="profession" class="box" required>
               ...
               <option value="Meditator">Meditator</option>
               ...
               <option value="General studies teacher">General studies teacher</option>
            </select>
      ...
      <a href="http://localhost/final%20project%20model/"><input type="button" name="Backtohome" value="Back To Home" class="btn"></a>
   </form>
